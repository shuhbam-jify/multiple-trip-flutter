...
LocationSuggestion locationSuggestionFromJson(String str) =>
    LocationSuggestion.fromJson(json.decode(str));

String locationSuggestionToJson(LocationSuggestion data) =>
